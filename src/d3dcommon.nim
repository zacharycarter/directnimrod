...
type 
  D3D_DRIVER_TYPE* {.size: sizeof(cint).} = enum 
    ...
    D3D_DRIVER_TYPE_HARDWARE = (0 + 1), 
    D3D_DRIVER_TYPE_REFERENCE = (1 + 1), 
    D3D_DRIVER_TYPE_NULL = (2 + 1), 
    D3D_DRIVER_TYPE_SOFTWARE = (3 + 1), 
    D3D_DRIVER_TYPE_WARP = (4 + 1)
  D3D_FEATURE_LEVEL* {.size: sizeof(cint).} = enum 
    D3D_FEATURE_LEVEL_9_1 = 0x00009100, D3D_FEATURE_LEVEL_9_2 = 0x00009200, 
    D3D_FEATURE_LEVEL_9_3 = 0x00009300, D3D_FEATURE_LEVEL_10_0 = 0x0000A000, 
    D3D_FEATURE_LEVEL_10_1 = 0x0000A100, D3D_FEATURE_LEVEL_11_0 = 0x0000B000, 
    D3D_FEATURE_LEVEL_11_1 = 0x0000B100, D3D_FEATURE_LEVEL_12_0 = 0x0000C000,
...
type 
  D3D_PRIMITIVE_TOPOLOGY* {.size: sizeof(cint).} = enum 
  ...
  D3D10_PRIMITIVE_TOPOLOGY* {.size: sizeof(cint).} = enum
  ...
  D3D11_PRIMITIVE_TOPOLOGY* {.size: sizeof(cint).} = enum
  ...
  D3D_PRIMITIVE* {.size: sizeof(cint).} = enum 
    D3D_PRIMITIVE_UNDEFINED = 0, D3D_PRIMITIVE_POINT = 1, 
    D3D_PRIMITIVE_LINE = 2, D3D_PRIMITIVE_TRIANGLE = 3, 
    D3D_PRIMITIVE_LINE_ADJ = 6, D3D_PRIMITIVE_TRIANGLE_ADJ = 7, 
    ...
    D3D_PRIMITIVE_20_CONTROL_POINT_PATCH = 28, # note this value is different in win10, MSDN lists the 8.1 values so I'm using those
  ...
  D3D10_PRIMITIVE* {.size: sizeof(cint).} = enum
  ...
  D3D11_PRIMITIVE* {.size: sizeof(cint).} = enum
  ...
  D3D_SRV_DIMENSION* {.size: sizeof(cint).} = enum 
    D3D_SRV_DIMENSION_UNKNOWN = 0, D3D_SRV_DIMENSION_BUFFER = 1, 
    ...
    D3D_SRV_DIMENSION_TEXTURE2DMS = 6, D3D_SRV_DIMENSION_TEXTURE2DMSARRAY = 7, 
    D3D_SRV_DIMENSION_TEXTURE3D = 8, D3D_SRV_DIMENSION_TEXTURECUBE = 9, 
    D3D_SRV_DIMENSION_TEXTURECUBEARRAY = 10, D3D_SRV_DIMENSION_BUFFEREX = 11, 
  D3D10_SRV_DIMENSION* {.size: sizeof(cint).} = enum
  ...
  D3D10_1_SRV_DIMENSION* {.size: sizeof(cint).} = enum
    ...
    D3D10_1_SRV_DIMENSION_TEXTURE2DMS = D3D_SRV_DIMENSION_TEXTURE2DMS, D3D10_1_SRV_DIMENSION_TEXTURE2DMSARRAY = D3D_SRV_DIMENSION_TEXTURE2DMSARRAY, 
    D3D10_1_SRV_DIMENSION_TEXTURE3D = D3D_SRV_DIMENSION_TEXTURE3D, 
    D3D10_1_SRV_DIMENSION_TEXTURECUBE = D3D_SRV_DIMENSION_TEXTURECUBE, D3D10_1_SRV_DIMENSION_TEXTURECUBEARRAY = D3D_SRV_DIMENSION_TEXTURECUBEARRAY, 
  D3D11_SRV_DIMENSION* {.size: sizeof(cint).} = enum
  ...
  LPD3D_SHADER_MACRO* = ptr D3D_SHADER_MACRO
...
var IID_ID3D10Blob* {.importc.}: IID

type 
  ID3D10BlobVtbl* = object 
    QueryInterface*: proc (This: ptr ID3D10Blob; riid: ptr IID; 
                           ppvObject: ptr pointer): HRESULT {.stdcall.} # [in] 
                                                                        # 
                                                                        # [annotation][iid_is][out] 
    AddRef*: proc (This: ptr ID3D10Blob): ULONG {.stdcall.}
    Release*: proc (This: ptr ID3D10Blob): ULONG {.stdcall.}
    GetBufferPointer*: proc (This: ptr ID3D10Blob): LPVOID {.stdcall.}
    GetBufferSize*: proc (This: ptr ID3D10Blob): SIZE_T {.stdcall.}

  ID3D10Blob* = object 
    lpVtbl*: ptr ID3D10BlobVtbl
...
type 
  LPD3D10BLOB* = ptr ID3D10Blob
  ID3DBlob* = ID3D10Blob
  LPD3DBLOB* = ptr ID3DBlob
  D3D_INCLUDE_TYPE* {.size: sizeof(cint).} = enum 
    D3D_INCLUDE_LOCAL = 0, D3D_INCLUDE_SYSTEM = (0 + 1),
    D3D_INCLUDE_FORCE_DWORD = 0x7FFFFFFF
  D3D10_INCLUDE_TYPE* {.size: sizeof(cint).} = enum
    D3D10_INCLUDE_LOCAL = D3D_INCLUDE_LOCAL, 
    D3D10_INCLUDE_SYSTEM = D3D_INCLUDE_SYSTEM, 
  ID3DInclude* = object 
    lpVtbl*: ptr ID3DIncludeVtbl

  ID3DIncludeVtbl* = object 
    Open*: proc (This: ptr ID3DInclude; IncludeType: D3D_INCLUDE_TYPE; 
                 pFileName: LPCSTR; pParentData: LPCVOID; ppData: ptr LPCVOID; 
                 pBytes: ptr UINT): HRESULT {.stdcall.}
    Close*: proc (This: ptr ID3DInclude; pData: LPCVOID): HRESULT {.stdcall.}

  LPD3DINCLUDE* = ptr ID3DInclude
  D3D_SHADER_VARIABLE_CLASS* {.size: sizeof(cint).} = enum 
    D3D_SVC_SCALAR = 0, D3D_SVC_VECTOR = (0 + 1), 
    D3D_SVC_MATRIX_ROWS = (1 + 1), 
    D3D_SVC_MATRIX_COLUMNS = (2 + 1), 
    D3D_SVC_OBJECT = (3 + 1), 
    D3D_SVC_STRUCT = (4 + 1), 
    D3D_SVC_INTERFACE_CLASS = (5 + 1), 
    D3D_SVC_INTERFACE_POINTER = (6 + 1),
    D3D_SVC_FORCE_DWORD = 0x7FFFFFFF
  D3D10_SHADER_VARIABLE_CLASS* {.size: sizeof(cint).} = enum
    D3D10_SVC_SCALAR = D3D_SVC_SCALAR, D3D10_SVC_VECTOR = D3D_SVC_VECTOR, 
    D3D10_SVC_MATRIX_ROWS = D3D_SVC_MATRIX_ROWS, 
    D3D10_SVC_MATRIX_COLUMNS = D3D_SVC_MATRIX_COLUMNS, 
    D3D10_SVC_OBJECT = D3D_SVC_OBJECT, D3D10_SVC_STRUCT = D3D_SVC_STRUCT, 
  D3D11_SHADER_VARIABLE_CLASS* {.size: sizeof(cint).} = enum
    D3D11_SVC_INTERFACE_CLASS = D3D_SVC_INTERFACE_CLASS, 
    D3D11_SVC_INTERFACE_POINTER = D3D_SVC_INTERFACE_POINTER, 
  D3D_SHADER_VARIABLE_FLAGS* {.size: sizeof(cint).} = enum 
    D3D_SVF_USERPACKED = 1, D3D_SVF_USED = 2, D3D_SVF_INTERFACE_POINTER = 4, 
    D3D_SVF_INTERFACE_PARAMETER = 8, 
    D3D_SVF_FORCE_DWORD = 0x7FFFFFFF
  D3D10_SHADER_VARIABLE_FLAGS* {.size: sizeof(cint).} = enum
    D3D10_SVF_USERPACKED = D3D_SVF_USERPACKED, 
    D3D10_SVF_USED = D3D_SVF_USED, 
  D3D11_SHADER_VARIABLE_FLAGS* {.size: sizeof(cint).} = enum
    D3D11_SVF_INTERFACE_POINTER = D3D_SVF_INTERFACE_POINTER, 
    D3D11_SVF_INTERFACE_PARAMETER = D3D_SVF_INTERFACE_PARAMETER, 
  D3D_SHADER_VARIABLE_TYPE* {.size: sizeof(cint).} = enum 
    D3D_SVT_VOID = 0, D3D_SVT_BOOL = 1, D3D_SVT_INT = 2, D3D_SVT_FLOAT = 3, 
    D3D_SVT_STRING = 4, D3D_SVT_TEXTURE = 5, D3D_SVT_TEXTURE1D = 6, 
    D3D_SVT_TEXTURE2D = 7, D3D_SVT_TEXTURE3D = 8, D3D_SVT_TEXTURECUBE = 9, 
    D3D_SVT_SAMPLER = 10, D3D_SVT_SAMPLER1D = 11, D3D_SVT_SAMPLER2D = 12, 
    D3D_SVT_SAMPLER3D = 13, D3D_SVT_SAMPLERCUBE = 14, D3D_SVT_PIXELSHADER = 15, 
    D3D_SVT_VERTEXSHADER = 16, D3D_SVT_PIXELFRAGMENT = 17, 
    D3D_SVT_VERTEXFRAGMENT = 18, D3D_SVT_UINT = 19, D3D_SVT_UINT8 = 20, 
    D3D_SVT_GEOMETRYSHADER = 21, D3D_SVT_RASTERIZER = 22, 
    D3D_SVT_DEPTHSTENCIL = 23, D3D_SVT_BLEND = 24, D3D_SVT_BUFFER = 25, 
    D3D_SVT_CBUFFER = 26, D3D_SVT_TBUFFER = 27, D3D_SVT_TEXTURE1DARRAY = 28, 
    D3D_SVT_TEXTURE2DARRAY = 29, D3D_SVT_RENDERTARGETVIEW = 30, 
    D3D_SVT_DEPTHSTENCILVIEW = 31, D3D_SVT_TEXTURE2DMS = 32, 
    D3D_SVT_TEXTURE2DMSARRAY = 33, D3D_SVT_TEXTURECUBEARRAY = 34, 
    D3D_SVT_HULLSHADER = 35, D3D_SVT_DOMAINSHADER = 36, 
    D3D_SVT_INTERFACE_POINTER = 37, D3D_SVT_COMPUTESHADER = 38, 
    D3D_SVT_DOUBLE = 39, D3D_SVT_RWTEXTURE1D = 40, 
    D3D_SVT_RWTEXTURE1DARRAY = 41, D3D_SVT_RWTEXTURE2D = 42, 
    D3D_SVT_RWTEXTURE2DARRAY = 43, D3D_SVT_RWTEXTURE3D = 44, 
    D3D_SVT_RWBUFFER = 45, D3D_SVT_BYTEADDRESS_BUFFER = 46, 
    D3D_SVT_RWBYTEADDRESS_BUFFER = 47, D3D_SVT_STRUCTURED_BUFFER = 48, 
    D3D_SVT_RWSTRUCTURED_BUFFER = 49, D3D_SVT_APPEND_STRUCTURED_BUFFER = 50, 
    D3D_SVT_CONSUME_STRUCTURED_BUFFER = 51, D3D_SVT_MIN8FLOAT = 52, 
    D3D_SVT_MIN10FLOAT = 53, D3D_SVT_MIN16FLOAT = 54, D3D_SVT_MIN12INT = 55, 
    D3D_SVT_MIN16INT = 56, D3D_SVT_MIN16UINT = 57,
  D3D10_SHADER_VARIABLE_TYPE* {.size: sizeof(cint).} = enum
    D3D10_SVT_VOID = D3D_SVT_VOID, D3D10_SVT_BOOL = D3D_SVT_BOOL, 
    D3D10_SVT_INT = D3D_SVT_INT, D3D10_SVT_FLOAT = D3D_SVT_FLOAT, 
    D3D10_SVT_STRING = D3D_SVT_STRING, D3D10_SVT_TEXTURE = D3D_SVT_TEXTURE, 
    ...
    D3D10_SVT_UINT = D3D_SVT_UINT, D3D10_SVT_UINT8 = D3D_SVT_UINT8, 
    ...
    D3D10_SVT_BLEND = D3D_SVT_BLEND, D3D10_SVT_BUFFER = D3D_SVT_BUFFER, 
    D3D10_SVT_CBUFFER = D3D_SVT_CBUFFER, D3D10_SVT_TBUFFER = D3D_SVT_TBUFFER, 
  ...
  D3D11_SHADER_VARIABLE_TYPE* {.size: sizeof(cint).} = enum
  ...
  D3D_SHADER_INPUT_FLAGS* {.size: sizeof(cint).} = enum 
    D3D_SIF_USERPACKED = 0x00000001, D3D_SIF_COMPARISON_SAMPLER = 0x00000002, 
    D3D_SIF_TEXTURE_COMPONENT_0 = 0x00000004, 
    D3D_SIF_TEXTURE_COMPONENT_1 = 0x00000008, 
    D3D_SIF_TEXTURE_COMPONENTS = 0x0000000C, D3D_SIF_UNUSED = 0x00000010, 
    D3D_SIF_FORCE_DWORD = 0x7FFFFFFF
  D3D10_SHADER_INPUT_FLAGS* {.size: sizeof(cint).} = enum
  ...
  D3D_SHADER_INPUT_TYPE* {.size: sizeof(cint).} = enum 
    D3D_SIT_CBUFFER = 0, D3D_SIT_TBUFFER = (0 + 1), 
    D3D_SIT_TEXTURE = (1 + 1), 
    D3D_SIT_SAMPLER = (2 + 1), 
    D3D_SIT_UAV_RWTYPED = (3 + 1), 
    D3D_SIT_STRUCTURED = (4 + 1), 
    D3D_SIT_UAV_RWSTRUCTURED = (5 + 1), 
    D3D_SIT_BYTEADDRESS = (6 + 1), 
    D3D_SIT_UAV_RWBYTEADDRESS = (7 + 1), 
    D3D_SIT_UAV_APPEND_STRUCTURED = (8 + 1), 
    D3D_SIT_UAV_CONSUME_STRUCTURED = (9 + 1), D3D_SIT_UAV_RWSTRUCTURED_WITH_COUNTER = (
        10 + 1),
  D3D10_SHADER_INPUT_TYPE* {.size: sizeof(cint).} = enum
    D3D10_SIT_CBUFFER = D3D_SIT_CBUFFER, D3D10_SIT_TBUFFER = D3D_SIT_TBUFFER, 
    D3D10_SIT_TEXTURE = D3D_SIT_TEXTURE, D3D10_SIT_SAMPLER = D3D_SIT_SAMPLER, 
  D3D11_SHADER_INPUT_TYPE* {.size: sizeof(cint).} = enum
  ...
  D3D_SHADER_CBUFFER_FLAGS* {.size: sizeof(cint).} = enum 
    D3D_CBF_USERPACKED = 1, 
    D3D_CBF_FORCE_DWORD = 0x7FFFFFFF
  D3D10_SHADER_CBUFFER_FLAGS* {.size: sizeof(cint).} = enum
    D3D10_CBF_USERPACKED = D3D_CBF_USERPACKED, 
  D3D_CBUFFER_TYPE* {.size: sizeof(cint).} = enum 
    D3D_CT_CBUFFER = 0, D3D_CT_TBUFFER = (1 + 1), 
    D3D_CT_INTERFACE_POINTERS = (2 + 1), 
    D3D_CT_RESOURCE_BIND_INFO = (3 + 1),
  D3D10_CBUFFER_TYPE* {.size: sizeof(cint).} = enum
    D3D10_CT_CBUFFER = D3D_CT_CBUFFER, D3D10_CT_TBUFFER = D3D_CT_TBUFFER, 
  D3D11_CBUFFER_TYPE* {.size: sizeof(cint).} = enum
    D3D11_CT_CBUFFER = D3D_CT_CBUFFER, D3D11_CT_TBUFFER = D3D_CT_TBUFFER, 
    D3D11_CT_INTERFACE_POINTERS = D3D_CT_INTERFACE_POINTERS, 
    D3D11_CT_RESOURCE_BIND_INFO = D3D_CT_RESOURCE_BIND_INFO
  D3D_NAME* {.size: sizeof(cint).} = enum 
    D3D_NAME_UNDEFINED = 0, D3D_NAME_POSITION = 1, D3D_NAME_CLIP_DISTANCE = 2, 
    D3D_NAME_CULL_DISTANCE = 3, D3D_NAME_RENDER_TARGET_ARRAY_INDEX = 4, 
    D3D_NAME_VIEWPORT_ARRAY_INDEX = 5, D3D_NAME_VERTEX_ID = 6, 
    D3D_NAME_PRIMITIVE_ID = 7, D3D_NAME_INSTANCE_ID = 8, 
    D3D_NAME_IS_FRONT_FACE = 9, D3D_NAME_SAMPLE_INDEX = 10, 
    D3D_NAME_FINAL_QUAD_EDGE_TESSFACTOR = 11, 
    D3D_NAME_FINAL_QUAD_INSIDE_TESSFACTOR = 12, 
    D3D_NAME_FINAL_TRI_EDGE_TESSFACTOR = 13, 
    D3D_NAME_FINAL_TRI_INSIDE_TESSFACTOR = 14, 
    D3D_NAME_FINAL_LINE_DETAIL_TESSFACTOR = 15, 
    D3D_NAME_FINAL_LINE_DENSITY_TESSFACTOR = 16, D3D_NAME_TARGET = 64, 
    D3D_NAME_DEPTH = 65, D3D_NAME_COVERAGE = 66, 
    D3D_NAME_DEPTH_GREATER_EQUAL = 67, D3D_NAME_DEPTH_LESS_EQUAL = 68, 
    D3D_NAME_STENCIL_REF = 69, D3D_NAME_INNER_COVERAGE = 70
  D3D10_NAME* {.size: sizeof(cint).} = enum
    ...
    D3D10_NAME_TARGET = D3D_NAME_TARGET, D3D10_NAME_DEPTH = D3D_NAME_DEPTH, 
    D3D10_NAME_COVERAGE = D3D_NAME_COVERAGE, 
  D3D11_NAME* {.size: sizeof(cint).} = enum
    D3D11_NAME_FINAL_QUAD_EDGE_TESSFACTOR = D3D_NAME_FINAL_QUAD_EDGE_TESSFACTOR, D3D11_NAME_FINAL_QUAD_INSIDE_TESSFACTOR = D3D_NAME_FINAL_QUAD_INSIDE_TESSFACTOR, 
    ...
    D3D11_NAME_INNTER_COVERAGE = D3D_NAME_INNER_COVERAGE
  D3D_RESOURCE_RETURN_TYPE* {.size: sizeof(cint).} = enum 
    D3D_RETURN_TYPE_UNORM = 1, D3D_RETURN_TYPE_SNORM = 2, 
    D3D_RETURN_TYPE_SINT = 3, D3D_RETURN_TYPE_UINT = 4, 
    D3D_RETURN_TYPE_FLOAT = 5, D3D_RETURN_TYPE_MIXED = 6, 
    D3D_RETURN_TYPE_DOUBLE = 7, D3D_RETURN_TYPE_CONTINUED = 8, 
  D3D10_RESOURCE_RETURN_TYPE* {.size: sizeof(cint).} = enum
  ...
  D3D11_RESOURCE_RETURN_TYPE* {.size: sizeof(cint).} = enum
  ...
  D3D_REGISTER_COMPONENT_TYPE* {.size: sizeof(cint).} = enum 
  ...
  D3D10_REGISTER_COMPONENT_TYPE* {.size: sizeof(cint).} = enum
  ...
  D3D_TESSELLATOR_DOMAIN* {.size: sizeof(cint).} = enum 
    D3D_TESSELLATOR_DOMAIN_UNDEFINED = 0, D3D_TESSELLATOR_DOMAIN_ISOLINE = 1, 
    D3D_TESSELLATOR_DOMAIN_TRI = 2, D3D_TESSELLATOR_DOMAIN_QUAD = 3, 
  D3D11_RESSELATOR_DOMAIN* {.size: sizeof(cint).} = enum
  ...
  D3D_TESSELLATOR_PARTITIONING* {.size: sizeof(cint).} = enum 
    D3D_TESSELLATOR_PARTITIONING_UNDEFINED = 0, 
    D3D_TESSELLATOR_PARTITIONING_INTEGER = 1, 
    D3D_TESSELLATOR_PARTITIONING_POW2 = 2, 
    D3D_TESSELLATOR_PARTITIONING_FRACTIONAL_ODD = 3, 
    D3D_TESSELLATOR_PARTITIONING_FRACTIONAL_EVEN = 4, 
  D3D11_TESSELATOR_PARTITIONING* {.size: sizeof(cint).} = enum
    D3D11_TESSELLATOR_PARTITIONING_UNDEFINED = D3D_TESSELLATOR_PARTITIONING_UNDEFINED, D3D11_TESSELLATOR_PARTITIONING_INTEGER = D3D_TESSELLATOR_PARTITIONING_INTEGER, 
    D3D11_TESSELLATOR_PARTITIONING_POW2 = D3D_TESSELLATOR_PARTITIONING_POW2, D3D11_TESSELLATOR_PARTITIONING_FRACTIONAL_ODD = D3D_TESSELLATOR_PARTITIONING_FRACTIONAL_ODD, D3D11_TESSELLATOR_PARTITIONING_FRACTIONAL_EVEN = D3D_TESSELLATOR_PARTITIONING_FRACTIONAL_EVEN
  D3D_TESSELLATOR_OUTPUT_PRIMITIVE* {.size: sizeof(cint).} = enum 
    D3D_TESSELLATOR_OUTPUT_UNDEFINED = 0, D3D_TESSELLATOR_OUTPUT_POINT = 1, 
    D3D_TESSELLATOR_OUTPUT_LINE = 2, D3D_TESSELLATOR_OUTPUT_TRIANGLE_CW = 3, 
    D3D_TESSELLATOR_OUTPUT_TRIANGLE_CCW = 4, 
  D3D11_TESSELATOR_OUTPUT_PRIMITIVE* {.size: sizeof(cint).} = enum
  ...
  D3D_MIN_PRECISION* {.size: sizeof(cint).} = enum 
    D3D_MIN_PRECISION_DEFAULT = 0, D3D_MIN_PRECISION_FLOAT_16 = 1, 
    D3D_MIN_PRECISION_FLOAT_2_8 = 2, D3D_MIN_PRECISION_RESERVED = 3, 
    D3D_MIN_PRECISION_SINT_16 = 4, D3D_MIN_PRECISION_UINT_16 = 5, 
    D3D_MIN_PRECISION_ANY_16 = 0x000000F0, D3D_MIN_PRECISION_ANY_10 = 0x000000F1
  D3D_INTERPOLATION_MODE* {.size: sizeof(cint).} = enum 
    D3D_INTERPOLATION_UNDEFINED = 0, D3D_INTERPOLATION_CONSTANT = 1, 
    D3D_INTERPOLATION_LINEAR = 2, D3D_INTERPOLATION_LINEAR_CENTROID = 3, 
    D3D_INTERPOLATION_LINEAR_NOPERSPECTIVE = 4, 
    D3D_INTERPOLATION_LINEAR_NOPERSPECTIVE_CENTROID = 5, 
    D3D_INTERPOLATION_LINEAR_SAMPLE = 6, 
    D3D_INTERPOLATION_LINEAR_NOPERSPECTIVE_SAMPLE = 7
  D3D_PARAMETER_FLAGS* {.size: sizeof(cint).} = enum
    D3D_PF_NONE = 0,
    D3D_PF_IN = 0x1,
    D3D_PF_OUT  = 0x2,
...
var WKPDID_D3DDebugObjectName* {.importc.}: GUID
var WKPDID_D3DDebugObjectNameW* {.importc.}: GUID
var WKPDID_CommentStringW* {.importc.}: GUID
