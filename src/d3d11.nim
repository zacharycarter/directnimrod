...
type
  ...
  D3D11_DRAW_INSTANCED_INDIRECT_ARGS* = object 
    VertexCountPerInstance*: UINT
    InstanceCount*: UINT
    StartVertexLocation*: UINT
    StartInstanceLocation*: UINT

  D3D11_DRAW_INDEXED_INSTANCED_INDIRECT_ARGS* = object 
  ...
  D3D11_FEATURE_DATA_D3D11_OPTIONS2* = object 
  ...
  D3D11_FEATURE_DATA_D3D11_OPTIONS3* = object 
    VPAndRTArrayIndexFromAnyShaderFeedingRasterizer*: BOOL

  D3D11_FEATURE_DATA_GPU_VIRTUAL_ADDRESS_SUPPORT* = object 
