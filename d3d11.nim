...
type
  ...
  D3D11_COLOR_WRITE_ENABLE* {.size: sizeof(cint).} = enum 
    ...
    D3D11_COLOR_WRITE_ENABLE_BLUE = 4, D3D11_COLOR_WRITE_ENABLE_ALPHA = 8, D3D11_COLOR_WRITE_ENABLE_ALL = (((
        D3D11_COLOR_WRITE_ENABLE_RED or D3D11_COLOR_WRITE_ENABLE_GREEN) or
  ...
  D3D11_QUERY* {.size: sizeof(cint).} = enum 
    D3D11_QUERY_EVENT = 0, D3D11_QUERY_OCCLUSION = (D3D11_QUERY_EVENT + 1), 
    ...
    D3D11_QUERY_SO_OVERFLOW_PREDICATE = (D3D11_QUERY_SO_STATISTICS + 1), D3D11_QUERY_SO_STATISTICS_STREAM0 = (
        D3D11_QUERY_SO_OVERFLOW_PREDICATE + 1), D3D11_QUERY_SO_OVERFLOW_PREDICATE_STREAM0 = (
        D3D11_QUERY_SO_STATISTICS_STREAM0 + 1), D3D11_QUERY_SO_STATISTICS_STREAM1 = (
        D3D11_QUERY_SO_OVERFLOW_PREDICATE_STREAM0 + 1), D3D11_QUERY_SO_OVERFLOW_PREDICATE_STREAM1 = (
        D3D11_QUERY_SO_STATISTICS_STREAM1 + 1), D3D11_QUERY_SO_STATISTICS_STREAM2 = (
  ...
  D3D11_FEATURE* {.size: sizeof(cint).} = enum 
    ...
    D3D11_FEATURE_FORMAT_SUPPORT2 = (D3D11_FEATURE_FORMAT_SUPPORT + 1), D3D11_FEATURE_D3D10_X_HARDWARE_OPTIONS = (
    ...
    D3D11_FEATURE_D3D9_OPTIONS = (D3D11_FEATURE_ARCHITECTURE_INFO + 1), D3D11_FEATURE_SHADER_MIN_PRECISION_SUPPORT = (
        D3D11_FEATURE_D3D9_OPTIONS + 1), D3D11_FEATURE_D3D9_SHADOW_SUPPORT = (
        D3D11_FEATURE_SHADER_MIN_PRECISION_SUPPORT + 1), 
    D3D11_FEATURE_D3D11_OPTIONS1 = (D3D11_FEATURE_D3D9_SHADOW_SUPPORT + 1), D3D11_FEATURE_D3D9_SIMPLE_INSTANCING_SUPPORT = (
        D3D11_FEATURE_D3D11_OPTIONS1 + 1), D3D11_FEATURE_MARKER_SUPPORT = (
...
proc D3D11CreateDeviceAndSwapChain*(pAdapter: ptr IDXGIAdapter; 
                                    ...
                                    ppDevice: ptr ptr ID3D11Device; 
                                    pFeatureLevel: ptr D3D_FEATURE_LEVEL; 
    ppImmediateContext: ptr ptr ID3D11DeviceContext): HRESULT {.stdcall.}
